// ======================================================================
// \title  MissionDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef MISSIONDEPLOYMENT_MISSIONDEPLOYMENTTOPOLOGY_HPP
#define MISSIONDEPLOYMENT_MISSIONDEPLOYMENTTOPOLOGY_HPP
// Included for access to MissionDeployment::TopologyState and MissionDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <MissionDeployment/Top/MissionDeploymentTopologyDefs.hpp>

// Remove unnecessary MissionDeployment:: qualifications
 ...
 * MissionDeployment::TopologyState see: MissionDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type MissionDeployment::TopologyState see: MissionDeploymentTopologyDefs.hpp.
 *
