...
static void signalHandler(int signum) {
    LocalDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    LocalDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    LocalDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
