// ======================================================================
// \title  LocalDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef LOCALDEPLOYMENT_LOCALDEPLOYMENTTOPOLOGY_HPP
#define LOCALDEPLOYMENT_LOCALDEPLOYMENTTOPOLOGY_HPP
// Included for access to LocalDeployment::TopologyState and LocalDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <LocalDeployment/Top/LocalDeploymentTopologyDefs.hpp>

// Remove unnecessary LocalDeployment:: qualifications
 ...
 * LocalDeployment::TopologyState see: LocalDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type LocalDeployment::TopologyState see: LocalDeploymentTopologyDefs.hpp.
 *
